...
/* Dsc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DSC"
#define QAPP_ORG_DOMAIN "dsc.org"
#define QAPP_APP_NAME_DEFAULT "DSC-Qt"
#define QAPP_APP_NAME_TESTNET "DSC-Qt-testnet"

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DSC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DSC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dsc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDSC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DSC Core"), this);
    aboutAction->setStatusTip(tr("Show information about DSC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DSC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DSC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DSC addresses"));
    ...
    openAction->setStatusTip(tr("Open a DSC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DSC Core help message to get a list with possible DSC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DSC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DSC network", "", count));
}
...
{
    QString strTitle = tr("DSC Core"); // default title

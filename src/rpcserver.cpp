...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DSC features */
        {"dsc", "masternode", &masternode, true, true, false},
        {"dsc", "listmasternodes", &listmasternodes, true, true, false},
        {"dsc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dsc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dsc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dsc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dsc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dsc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dsc", "masternodedebug", &masternodedebug, true, true, false},
        {"dsc", "startmasternode", &startmasternode, true, true, false},
        {"dsc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dsc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dsc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dsc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dsc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dsc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dsc", "mnbudget", &mnbudget, true, true, false},
        {"dsc", "preparebudget", &preparebudget, true, true, false},
        {"dsc", "submitbudget", &submitbudget, true, true, false},
        {"dsc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dsc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dsc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dsc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dsc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dsc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dsc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dsc", "checkbudgets", &checkbudgets, true, true, false},
        {"dsc", "mnsync", &mnsync, true, true, false},
        {"dsc", "spork", &spork, true, true, false},
        {"dsc", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> dsc-cli " + methodname + " " + args + "\n";
}

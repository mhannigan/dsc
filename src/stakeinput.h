...
#ifndef DSC_STAKEINPUT_H
#define DSC_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZDSC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zDSCStake can take two forms
...
public:
    ...
    bool IsZDSC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZDSC() override { return false; }
};


#endif //DSC_STAKEINPUT_H

...
This mechanism has been integrated into Bitcore-Node-DSC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DSC-Project/insight-api-dsc#web-socket-api](https://github.com/DSC-Project/insight-api-dsc#web-socket-api) 
* API: [https://github.com/DSC-Project/insight-api-dsc#swifttx-transactions](https://github.com/DSC-Project/insight-api-dsc#swifttx-transactions) 
...
By default, the DSC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DSC Core daemon:

...
In order to support loading of multiple wallets in dsc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dsc.cpp.
...
Changes to dsc.cpp
----------------------
dsc.cpp is the entry point into dsc-qt, and as such, will require some minor modifications to provide hooks for

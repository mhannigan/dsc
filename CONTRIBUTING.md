Contributing to DSC Core
============================

The DSC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DSC Core project, and is not to be
confused with overall DSC Network Protocol consensus changes.

Whether a pull request is merged into DSC Core rests with the project merge
...
Patches that change DSC consensus rules are considerably more involved than
...
Where a patch set proposes to change the DSC consensus, it must have been
...
The project leader is the release manager for each DSC Core release.

...
RESOURCES += src/qt/dsc.qrc src/qt/dsc_locale.qrc

TRANSLATIONS += src/qt/locale/dsc_bg.ts \
                src/qt/locale/dsc_de.ts \
                src/qt/locale/dsc_en.ts \
                src/qt/locale/dsc_es.ts \
                src/qt/locale/dsc_fi.ts \
                src/qt/locale/dsc_fr.ts \
                src/qt/locale/dsc_it.ts \
                src/qt/locale/dsc_ja.ts \
                src/qt/locale/dsc_pl.ts \
                src/qt/locale/dsc_pt.ts \
                src/qt/locale/dsc_ru.ts \
                src/qt/locale/dsc_sk.ts \
                src/qt/locale/dsc_sv.ts \
                src/qt/locale/dsc_vi.ts \
                src/qt/locale/dsc_zh_CN.ts \
                src/qt/locale/dsc_zh_TW.ts
